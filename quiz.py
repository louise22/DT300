...
class Quiz:
    ...
    def __init__(self):
        ...
        self.questions = [Question("What is the capital of Mongolia?",
                 ...
                 "JK Rowling",
                 ["Stephanie Meyer", "EL James", "Margaret Mahy"]),
                 Question("What is the name of the 26th President of the United States",
                 "Theodore Roosevelt",
                 ["Abraham Lincoln", "Benjamin Harrison", "Jimmy Carter"])]
